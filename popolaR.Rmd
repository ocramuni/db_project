...
write.csv(addetti_df,"dati/addetti.csv", row.names = FALSE)
dbWriteTable(con, name=SQL('"public"."addetti"'), value=addetti_df, overwrite=T, row.names=F)
###########################
# Aree
# id, nome, apertura
...
write.csv(aree_df,"dati/aree.csv", row.names = FALSE)
dbWriteTable(con, name=SQL('"public"."aree"'), value=aree_df, overwrite=T, row.names=F)
###########################
...
write.csv(casa_df,"dati/casa.csv", row.names = FALSE)
dbWriteTable(con, name=SQL('"public"."casa_df"'), value=casa_df, overwrite=T, row.names=F)
###########################
# Gabbie
...
write.csv(gabbia_df,"dati/gabbia.csv", row.names = FALSE)
dbWriteTable(con, name=SQL('"public"."gabbia"'), value=gabbia_df, overwrite=T, row.names=F)
...
write.csv(generi_df,"dati/generi.csv", row.names = FALSE)
dbWriteTable(con, name=SQL('"public"."generi"'), value=generi_df, overwrite=T, row.names=F)
###########################
# Esemplari
...
write.csv(esemplari_df,"dati/esemplari.csv", row.names = FALSE)
dbWriteTable(con, name=SQL('"public"."esemplari"'), value=esemplari_df, overwrite=T, row.names=F)
###########################
# Controlli
...
write.csv(controlli_df,"dati/controlli.csv", row.names = FALSE)
dbWriteTable(con, name=SQL('"public"."controlli"'), value=controlli_df, overwrite=T, row.names=F)
```